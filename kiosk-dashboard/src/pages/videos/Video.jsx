...
//     try {
//       const response = await api.post('add-assets-to-playlists/', {
//         playlist_ids: [selectedPlaylist],
...
//   <div className="modal-overlay">
//     <div className="modal-content">
//       <h5 className='asset-modal-heading'>Add Asset to Playlist</h5>
//       <div>
//         <label className='asset-select'>Select Playlist:</label>
//         <select
...
//       </div>
//       <div>
//         <label className='asset-select'>Select Asset:</label>
//         <select
//           className="form-control"
//           value={selectedAsset}
//           onChange={(e) => {
...
//       </div>
//       <div className="modal-actions">
//         <button className='modal-button' onClick={handleAddAssetToPlaylist} 
//         style={{ background: 'teal', color: '#fff', borderRadius:"3px", border:"none" }}
//         >
//           Add
//         </button>
//         <button className='modal-button' onClick={() => setShowAddAssetModal(false)}
//          style={{ marginLeft: '10px', borderRadius:"3px", border:"1px solid #828282" }}>
//           Cancel
//         </button>
//       </div>
//     </div>
